...
class TestD5aInstrumentAdapter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_config = {
            ...
            'set_dac_unit': {'__class__': 'qcodes.instrument.parameter.Parameter',
                         'full_name': 'D5aInstrumentAdapter_spirack1_module3_dac_unit',
                         'instrument': 'qcodes.instrument_drivers.QuTech.D5a.D5a',
                         'instrument_name': 'D5aInstrumentAdapter_spirack1_module3',
                         'inter_delay': 0,
                         'label': 'dac_unit',
                         'name': 'dac_unit',
                         'post_delay': 0,
                         'raw_value': None,
                         'ts': '2019-05-28 14:07:52',
                         'unit': '',
                         'vals': "<Enum: {'V', 'mV'}>",
                         'value': 'V'},
            'stepsize1': {
